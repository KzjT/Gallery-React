        ...
        <div className="about-us container-fluid">
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="about-content">
                                ...
                                <p className="lead">
                                    Welcome to our art studio, where creativity and passion come together to create works
                                    amazing. With years of experience in the world of art, we are proud to present our creations
                                    unique and expressive.
                                </p>
                                <p>
                                    Our team is made up of Ana García, our Creative Director, and Luis Martínez, our
                                    Main Artist. Together, we combine our unique visions to produce art that resonates with
                                    emotions and deep meanings.
                                </p>
                                <p>
            ...
            <section className="work-section">
                <div className="container">
                    ...
                    <p className="lead">
                        Explore some of our latest artwork and discover the diversity of styles and techniques that
                        we use to express our creativity.
                    </p>
                    <div class="row featurette mt-5">
                        <div class="col-md-7 ">
                            <h2 class="featurette-heading fw-normal lh-1 title-color">First featurette heading. <span class="text-body-secondary title-color">It’ll blow your mind.</span></h2>
                    ...
                    <div class="row featurette">
                        <div class="col-md-7 order-md-2">
                            <h2 class="featurette-heading fw-normal lh-1 title-color">Oh yeah, it’s that good. <span class="text-body-secondary">See for yourself.</span></h2>
                    ...
                    <div class="row featurette">
                        <div class="col-md-7">
                            <h2 class="featurette-heading fw-normal lh-1 title-color">And lastly, this one. <span class="text-body-secondary">Checkmate.</span></h2>
